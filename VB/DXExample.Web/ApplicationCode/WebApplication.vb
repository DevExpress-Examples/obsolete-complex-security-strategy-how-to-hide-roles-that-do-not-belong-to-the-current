...
Namespace DXExample.Web
	Partial Public Class DXExampleAspNetApplication
		...
		Private Sub InitializeComponent()
            ...
            'sqlConnection1
            '
            Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=DXExample;Integrated Security=SSPI;Pooling=fa" & _
                "lse"
            ...
            Me.SecurityComplex1.RoleType = GetType(DXExample.[Module].CustomRole)
